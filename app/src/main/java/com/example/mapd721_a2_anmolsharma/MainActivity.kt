package com.example.mapd721_a2_anmolsharma
...
import com.example.mapd721_a2_anmolsharma.ui.theme.MAPD721A2AnmolSharmaTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            MAPD721A2AnmolSharmaTheme {
...
fun AboutSection() {
    Column {
        ...
        Text(text = "Student Name: Anmol Sharma")
        Text(text = "Student ID: 301364872")
    }
}
